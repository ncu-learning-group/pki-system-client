  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 leading-loose">
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-6">基于数字证书的数字签名应用的研究</h2>
            <p className="text-xl text-gray-700 tracking-wider">
              PKI 以带负载的数学运算为基础，被广泛应用于身份认证、信息安全、数据
              保密等领域之中，是目前为止世界范围内应用最为多样和广泛的一种加密和认证
              体系。
            </p>
          </div>

          {/* Items */}
          <div className="mb-16 max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none">
            {/* 1st item */}
            <div
            ...
            >
              ...
              <h4 className="h4 mb-2">数字签名</h4>
              <p className="text-lg text-gray-700 text-center">
                附加到明文数据或明文经过密码学算法转换后得到的数据
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">数字信封</h4>
              <p className="text-lg text-gray-700 text-center">
                在分发对称密钥之前，先使用非对称加密技术对对称密钥进行加密
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">防冒充</h4>
              <p className="text-lg text-gray-700 text-center">
                数字信封将对称加密和非对称加密
                技术进行了有机结合，取两者精华，既解决了私钥加密中私钥分发难度大，加密
                时间长的问题，又提高了加密的灵活性和高效性
              </p>
            </div>
